# mpi4py package README

This directoy contains the build files for the mpi4py package, which is part
of the mpi4py roll. Unique to the mpi4py roll/package is the bundled 
